                                            ...
                                            <div class="col-lg-5 col-md-7 col-sm-10 mx-auto">
                                                ...
                                                <div class="card card-flush">
                                                    <div class="card-body text-center">
                                                        ...
                                                        <p class="mb-4">No worries we will mail you 6 digit code to your
                                                            recovery email address to reset your password</p>
                                                        @if ($errors->any())
                                                        ...
                                                        <div class="row gx-3">
                                                            <div class="form-group col-lg-12">
                                                                <div class="form-label-group">
                                                                    ...
                                                                    <a href="#" class="fs-7 fw-medium">Forgot Username
                                                                        ?</a>
                                                                </div>
                                                                <input class="form-control" placeholder="Recovery email ID"
                                                                    name="email" value="" type="email">
                                                            </div>
                                                        </div>
                                                        <button class="btn btn-primary btn-uppercase btn-block">Send
                                                            Code</button>
                                                        <p class="p-xs mt-2 text-center">Did not receive code? <a
                                                                href="#"><u>Send again</u></a></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        <div class="row gx-3">
                                                            ...
                                                            <div class="form-group col-lg-12">
                                                                ...
                                                                <input class="form-control"
                                                                    placeholder="Recovery email ID" value=""
                                                                    name="password_confirmation" type="password">
                                                            </div>
                                                        </div>
                                                        <button
                                                            class="btn btn-primary btn-uppercase btn-block">Reset</button>
                                                        <p class="p-xs mt-2 text-center">Did not receive code? <a
                                                                href="#"><u>Send again</u></a></p>
                                                    </div>
                                                </div>
