                                    ...
                                    <div class="col-xl-7 col-sm-10 mx-auto">
                                        ...
                                        <div class="row gx-3">
                                            <div class="form-group col-lg-12">
                                                ...
                                                <input class="form-control" placeholder="Enter username or email ID" name="email" value="" type="email">
                                            </div>
                                            <div class="form-group col-lg-12">
                                                <div class="form-label-group">
                                                ...
                                                <div class="input-group password-check">
                                                    <span class="input-affix-wrapper affix-wth-text">
                                                        <input class="form-control" placeholder="Enter your password" name="password" value="" type="password">
