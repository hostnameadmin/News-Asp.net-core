                                    ...
                                    <div id="listHistory_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6">
                                                <div class="dataTables_length" id="listHistory_length"><label>Xem <select
                                                            name="listHistory_length" aria-controls="listHistory"
                                                    ...
                                                    <div class="dataTables_scrollHead"
                                                        ...
                                                        <div class="dataTables_scrollHeadInner"
                                                            ...
                                                            <table
                                                                ...
                                                                role="grid" style="margin-left: 0px; width: 1815.42px;">
                                                                <thead>
                                                                    <tr role="row">
                                                                        <th class="text-center sorting sorting_desc"
                                                                            tabindex="0" aria-controls="listHistory"
                                                                            rowspan="1" colspan="1"
                                                                            style="width: 67.0469px;" aria-sort="descending"
