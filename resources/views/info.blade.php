                        ...
                        <div class="card-body">
                            ...
                            @if (session('success'))
                                <div class="alert alert-success">
                                    <h6 class="heading-wth-icon alert-heading"><i class="fa fa-check"></i><b> Success!</b>
                                    </h6>
                                    {{ session('success') }}
                                </div>
                            @endif
                                    ...
                                    <form submit-ajax="true" action="{{ route('change_token') }}" method="post"
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <button type="submit" class="btn btn-primary"><i class="fa fa-sync"></i>
                                                    Thay
                                                    đổi</button>
                                            </div>
                                        </div>
                                    ...
                                    <div id="listDiary_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6">
                                                <div class="dataTables_length" id="listDiary_length"><label>Xem <select
                                                            name="listDiary_length" aria-controls="listDiary"
                                                    ...
                                                    <div class="dataTables_scrollHead"
                                                        ...
                                                        <div class="dataTables_scrollHeadInner"
                                                            ...
                                                            <table
                                                                ...
                                                                role="grid" style="margin-left: 0px; width: 1254px;">
                                                                <thead>
                                                                    <tr role="row">
                                                                ...
                                                                <tr role="row" style="height: 2px;">
                                                                    <th class="text-center sorting sorting_desc"
                                                                        ...
                                                                        <div class="dataTables_sizing"
                                                                            style="height: 0px; overflow: hidden;">ID</div>
                                                                    </th>
                                                                    ...
                                                                    <th class="text-center sorting"
                                                                        ...
                                                                        aria-label="Nội dung: activate to sort column ascending">
                                                                        <div class="dataTables_sizing"
                                                                            style="height: 0px; overflow: hidden;">Nội dung
                                                                        </div>
                                                                    </th>
                                                                </tr>
                                                            </thead>
                                                    ...
                                                    <ul class="pagination custom-pagination pagination-simple">
                                                        <li class="paginate_button page-item previous disabled"
                                                            id="listDiary_previous"><a href="#"
                                                                aria-controls="listDiary" data-dt-idx="0" tabindex="0"
                                                                class="page-link"><i class="ri-arrow-left-s-line"></i></a>
                                                        </li>
                                                        <li class="paginate_button page-item active"><a href="#"
                                                                aria-controls="listDiary" data-dt-idx="1" tabindex="0"
                                                                class="page-link">1</a></li>
                                                        <li class="paginate_button page-item "><a href="#"
                                                                aria-controls="listDiary" data-dt-idx="2" tabindex="0"
                                                                class="page-link">2</a></li>
                                                        <li class="paginate_button page-item "><a href="#"
                                                                aria-controls="listDiary" data-dt-idx="3" tabindex="0"
                                                                class="page-link">3</a></li>
                                                        <li class="paginate_button page-item "><a href="#"
                                                                aria-controls="listDiary" data-dt-idx="4" tabindex="0"
                                                                class="page-link">4</a></li>
                                                        <li class="paginate_button page-item "><a href="#"
                                                                aria-controls="listDiary" data-dt-idx="5" tabindex="0"
                                                                class="page-link">5</a></li>
                                                        <li class="paginate_button page-item disabled"
                                                            id="listDiary_ellipsis"><a href="#"
                                                                aria-controls="listDiary" data-dt-idx="6" tabindex="0"
                                                                class="page-link">…</a></li>
                                                        <li class="paginate_button page-item "><a href="#"
                                                                aria-controls="listDiary" data-dt-idx="7" tabindex="0"
                                                                class="page-link">20</a></li>
                                                        <li class="paginate_button page-item next" id="listDiary_next"><a
                                                                href="#" aria-controls="listDiary" data-dt-idx="8"
