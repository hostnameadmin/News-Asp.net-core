                    ...
                    <div class="row auth-split">
                        <div
                                ...
                                <div class="row">
                                    <div class="col-xxl-8 mx-auto">
                                        ...
                                        <ul class="list-icon text-white mt-4">
                                            <li class="mb-1">
                                                <p><i class="ri-check-fill"></i><span>There are many variations of passages
                                                        of Lorem Ipsum available, in some form, by injected humour</span>
                                                </p>
                                            </li>
                                            <li class="mb-1">
                                                <p><i class="ri-check-fill"></i><span>There are many variations of passages
                                        ...
                                        <div class="row gx-3 mt-7">
                                            <div class="col-lg-6">
                                                <div class="card card-shadow">
                                                    <img class="card-img-top"
                                                        src="{{ asset('theme/html/classic') }}/dist/img/slide1.jpg"
                                                        alt="Card image cap">
                                                    <div class="card-body">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="card card-shadow">
                                                    <img class="card-img-top"
                                                        src="{{ asset('theme/html/classic') }}/dist/img/slide2.jpg"
                                                        alt="Card image cap">
                                                    <div class="card-body">
                            ...
                            <p class="p-xs text-white credit-text opacity-55">All illustration are powered by <a
                                    href="https://icons8.com/ouch/" target="_blank" class="link-white"><u>OUCH</u></a></p>
                        </div>
                                ...
                                <form class="w-100" method="post" action="{{ route('register_send') }}">
                                    ...
                                    <div class="row">
                                        <div class="col-xxl-5 col-xl-7 col-lg-10 mx-auto">
                                            ...
                                            <button class="btn btn-outline-dark btn-rounded btn-block mb-3"><span><span
                                                        class="icon"><i class="fab fa-google"></i></span><span>Sign Up
                                                        with Gmail</span></span></button>
                                            <button class="btn btn-social btn-social-facebook btn-rounded btn-block"><span><span
                                                        class="icon"><i class="fab fa-facebook"></i></span><span>Sign Up
                                                        with Facebook</span></span></button>
                                                ...
                                                <div class="form-group col-lg-12">
                                                    ...
                                                    <div class="input-group password-check">
                                                        <span class="input-affix-wrapper affix-wth-text">
                                                            <input class="form-control" placeholder="6+ characters"
                                            ...
                                            <div class="form-check form-check-sm mb-3">
                                                ...
                                                <label class="form-check-label text-muted fs-8" for="logged_in">By
                                                    creating an account you specify that you have read and agree with our <a
                                                        href="#">Tearms of use</a> and <a href="#">Privacy
                                                        policy</a>. We may keep you inform about latest updates through our
                                                    default <a href="#">notification settings</a></label>
                                            </div>
