            ...
            <header>
                <div class="chatbot-head-top">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="#"><i
                                class="dropdown-icon zmdi zmdi-volume-off"></i><span>Mute Chat</span></a>
                    </div>
                    ...
                    <div class="d-flex">
                        <div class="d-flex flex-wrap justify-content-between flex-1">
                            <div class="mb-lg-0 mb-2 me-8">
                                <h1 class="pg-title">{{ $data['title'] }}</h1>
                                        ...
                                        <div class="text-truncate fs-6 mb-2">
                                            <font style="vertical-align: inherit;">
                                                <font style="vertical-align: inherit;" class="">
                                                    {{ str_replace(',', '.', number_format(Auth::user()->balance)) . ' VND' }}
                                                </font>
                                            </font>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="media fmapp-info-trigger">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="text-truncate fs-6 mb-2">
                                            <font style="vertical-align: inherit;">
                                                <font style="vertical-align: inherit;" class="">421 đồng xu</font>
                                            </font>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card card-border card-int mb-4">
                            <div class="card-body">
                                <div class="media fmapp-info-trigger">
                                    <div class="media-head me-3">
                                        <div class="avatar avatar-icon avatar-sm avatar-soft-success">
                                            <span class="initial-wrap"><i class="ri-arrow-left-right-line"></i></span>
                                        </div>
                                    </div>
                                    <div class="media-body">
                                            ...
                                            <div class="card-header card-header-action">
                                                ...
                                                <div class="card-action-wrap">
                                                    <div class="btn-group d-lg-flex d-none" role="group"
                                                        ...
                                                        <button type="button"
                                                            class="btn btn-outline-light">Source</button>
                                                        <button type="button"
                        ...
                        <div class="row">
                            <div class="col-xl-8">
                                <p class="footer-text"><span class="copy-text">Jampack © 2022 All rights
                                        ...
                                        class="" target="_blank">T&C</a><span class="footer-link-sep">|</span><a
